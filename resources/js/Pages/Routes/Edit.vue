...
const form = useForm({
    ...
    cenro: hasRole("admin") ? Boolean(props._route.cenro) : false,
});
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-5 p-5"
                >
                    <form @submit.prevent="submit">
                        <TextInput
                            ...
                            type="text"
                            label="Route Name"
                            placeholder="Greenland Phase 1 -to- Patul P-1"
