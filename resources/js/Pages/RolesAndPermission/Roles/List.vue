...
const handleDelete = () => {
    ...
    deleteForm.delete(
        route("users.roles.delete", { id: targetToDelete.value }),
        {
            onSuccess: () => {
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <Link
                    ...
                    ><PlusCircleIcon class="h-7" />Add Role</Link
                >
                <div
            ...
            <template #body>
                <div class="mt-5">
                    <span class="text-red-700"
                        >You are about to delete this role?</span
                    >
                </div>
            </template>
            <template #actions>
