...
import { Driver, ICities, Roles, Truck } from "../../types/interface";
...
const form = useForm({
    ...
    mobile_number: props.driver.mobile_number,
    barangay: props.driver.barangay,
    truck_id: props.driver.truck_id,
    cenro: props.cenro === "true" ? true : false,
});
...
const submit = () => {
    form.post(route("users.drivers.update", { id: props.driver.id }), {
        onError: () => {
                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit">
                            ...
                            <span
                                ...
                                >{{ form.errors.truck_id }}</span
                            >

                            <div class="flex justify-end mt-5 gap-2">
                                <Link
                                    :href="route('users.drivers.list')"
