...
<template>
    ...
    <div
        v-if="isSidebarOpen"
        class="fixed inset-0 bg-gray-600 bg-opacity-75 z-50"
        @click="closeSidebar"
    ></div>
            ...
            <ul class="space-y-1.5">
                ...
                <MenuItemDropdown label="Users" pattern="users">
                    ...
                    <MenuItem
                        v-if="hasRole('admin')"
                        pattern="users.all"
                        routeName="users.all.list"
                        label="Web Users"
                    />
                    <MenuItem
                        pattern="users.drivers"
                        routeName="users.drivers.list"
                        label="Drivers"
                    />
                    <MenuItem
                        v-if="hasRole('admin')"
                        pattern="users.residents"
                        routeName="users.residents.list"
                        label="Residents"
                    />
